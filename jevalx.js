...
if ('function'!=typeof clearTimeout){
  ...
  let WhiteList = new Set(['Object','Array','JSON','Promise','Function','eval','globalThis','Date','Math','Number','String','Set','console']);for (let v of Object.getOwnPropertyNames(this)){if(!WhiteList.has(v))delete this[v]}
};
...
let jevalx_core = async(js,ctx,options={})=>{
  ...
  try{rst = await new Promise((resolve,reject)=>{try{
    ...
    if (ctx && vm.isContext(ctx)) [ctxx,[_console]] = jevalx_raw(S_SESSION,ctx)[1];
    else {
